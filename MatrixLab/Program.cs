...
namespace Matrix
{
    class Program
    {
        public static double determinant(double[,] matrix)
        {
            ...
            else
            {
                for (int k = 0; k < size; k++)
                {
                    ...
                    if (k % 2 == 0)
                        result += matrix[0, k] * determinant(submatrix);
                    else
                        result += -1 * matrix[0, k] * determinant(submatrix);
                }
            }
            return result;
        }
        ...
        public static bool idSquareMartix(double[,]matrix)
        {
        ...
        public static double[,] RedhefferMatrix(int n)
        {
        ...
        public static void methodCramer(double[,]matrix)
        {
            ...
            if (determinant(mainMatrix) != 0)
            {
                for (int k = 0; k < rows; k++)
                {
                    ...
                    Console.WriteLine($"Корень {k + 1} = {determinant(rootMatrix) / determinant(mainMatrix)}");
                }
            }
            else
            {
        ...
        public static void userInterface()
        {
            ...
            else if (input == "вычислить определитель матрицы Редхеффера")
            {
                ...
                string input_matrix = Console.ReadLine();
                int size = Convert.ToInt32(input_matrix);
                double[,] matrix = RedhefferMatrix(size);
                Console.WriteLine("-------------------");
                Console.WriteLine("Матрица:");
                printMatrix(matrix);
                Console.WriteLine("-------------------");
            ...
            else throw new Exception("Проверьте ввод функции");
        }
        ...
        public static void test()
        {
            ...
            if (determinant(matrix_6) != 0)
                Console.WriteLine("err6");

            if (determinant(RedhefferMatrix(1)) != 1)
                Console.WriteLine("err7");

            if (determinant(RedhefferMatrix(2)) != 0)
                Console.WriteLine("err8");

            if (determinant(RedhefferMatrix(3)) != -1)
                Console.WriteLine("err9");

            if (determinant(RedhefferMatrix(4)) != -1)
                Console.WriteLine("err10");

            if (determinant(RedhefferMatrix(5)) != -2)
                Console.WriteLine("err11");

            if (determinant(RedhefferMatrix(6)) != -1)
                Console.WriteLine("err12");

            if (determinant(RedhefferMatrix(7)) != -2)
                Console.WriteLine("err13");

            if (determinant(RedhefferMatrix(8)) != -2)
                Console.WriteLine("err14");

            Console.WriteLine("Ответы: 3 , -4 , 1");
            Console.WriteLine("-------------------");
            methodCramer(new double[,] { { 6,2,-5,5 }, { 1,3,-1,-10 }, {3, -5, -4, 25} });
            Console.WriteLine("-------------------");

            Console.WriteLine("");
            Console.WriteLine("Ответы: 1 , 1 , 1");
            Console.WriteLine("-------------------");
            methodCramer(new double[,] { { 2, 3, -1, 4 }, { 1, 1, 3, 5 }, { 3, -4, 1, 0 } });
            Console.WriteLine("-------------------");

            Console.WriteLine("");
            Console.WriteLine("Ответы: -2 , 1 , -1");
            Console.WriteLine("-------------------");
            methodCramer(new double[,] { { 1, 5, 2, 1 }, { 2, 3, 2, -3 }, { 1, 3, 4, -3 } });
            Console.WriteLine("-------------------");

            Console.WriteLine("");
            Console.WriteLine("Ответы: бесконечное число решений");
            Console.WriteLine("-------------------");
            methodCramer(new double[,] { { 1,1,0 }, { 2, 2, 0} });
            Console.WriteLine("-------------------");

            Console.WriteLine("");
            Console.WriteLine("Ответы: бесконечное число решений");
            Console.WriteLine("-------------------");
            methodCramer(new double[,] { { 4,-8, 2 }, { 2,-4,1} });
            Console.WriteLine("-------------------");

            Console.WriteLine("");
            Console.WriteLine("Ответы: нет решений");
            Console.WriteLine("-------------------");
            methodCramer(new double[,] { { 3,-1,2 }, {3,-1,5} });
            Console.WriteLine("-------------------");

            Console.WriteLine("");
            Console.WriteLine("Ответы: нет решений");
            Console.WriteLine("-------------------");
            methodCramer(new double[,] { { 1, 1, 4 }, { 2, 2, 12 } });
            Console.WriteLine("-------------------");
